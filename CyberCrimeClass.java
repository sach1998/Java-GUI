...
public static Hashtable<String, source> fetch(){
   ...
   public static void createHTML(){
    ...
    try{
    FileWriter fw=new FileWriter("Allcomplaints.html");
    BufferedWriter bw=new BufferedWriter(fw);
    bw.write("<!Doctype html>");
    bw.newLine();
    bw.write("<html><head><title>All Complaints</title></head>");
    bw.newLine();
    bw.write("<body style='padding-left:80px'>");
    bw.newLine();
    bw.write("<p style='color:#9900ff; font-size:16pt'>Registered Complaints</p>");
    bw.write("<table>");
    bw.newLine();
    bw.write("<tr style='background-color:#00aaaa'><th> Complaint ID </th><th> Date </th><th> Time </th><th> Type </th><th> Name </th><th> Phone </th><th> Email </th><th> Address </th>");
    if(hash!=null){
     Set<String> set=hash.keySet();
     Iterator<String> iterator=set.iterator();
     while(iterator.hasNext()){
      source cu=hash.get(iterator.next());
     bw.write("<tr><td>"+cu.getId()+"</td><td>"+cu.getDate()+"</td><td>"+cu.getTime()+"</td><td>"+cu.getType()+"</td><td>"+cu.getName()+"</td><td>"+cu.getPhone()+"</td><td>"+cu.getEmail()+"</td><td>"+cu.getAddress()+"</td><tr>");
      bw.newLine();
      }
    ...
    bw.flush();
    bw.close();
    displayReport("allComplaints.html");
